          ...
          <div className="shopping_Address">
            <div className="new_Address">
              ...
              <div className="Payment">
                ...
                <div style={{ display: "flex" }}>
                  <BiPlusMedical
                    style={{ color: "#D5DBDB", fontSize: "24px" }}
                  />
                ...
                <span>Pay With Debit/Credit/ATM Card</span>
                <br />
                <p style={{ marginLeft: "20px", marginBottom: "auto" }}>
                  You can save your cards as per new RBI guidlines
                </p>

                <img src="Images/Visa.png" alt="" className="Visa_Img"></img>
                <img
                  src="Images/Maestro-icon.png"
                  alt=""
                  className="Visa_Img"
                ></img>
                ...
                <div style={{ marginTop: "20px" }}>
                  ...
                  <span style={{ fontWeight: "normal", marginLeft: "30px" }}>
                    Scan and pay using Amazone app (25 cashback on first
                    transaction ).Cash,UPI,Card also accepted.
                    <a style={{ color: "rgb(0, 113, 133)" }} href="g.com">
                      Know More
                    </a>
                  </span>
                  <hr />
