    ...
    <>
      <div className="click">
        <div className="Fitness">
          ...
          <div>
          <img src={ProductDetail.Images} className="Small" onMouseOverCapture={NewPhoto} onMouseLeave={OldPhoto} alt=""></img><br/>
          <img src={ProductDetail.Images} className="Small" onMouseOverCapture={NewPhoto} onMouseLeave={OldPhoto} alt=""></img><br/>
          <img src={ProductDetail.BeautyImage} className="Small" onMouseOverCapture={NewPhoto} onMouseLeave={OldPhoto} alt=""></img><br/>
          <img src={ProductDetail.BeautyImageOne} className="Small" alt=""></img><br/>
          <img src={ProductDetail.BeautyImageTwo} className="Small" alt=""></img>
          </div>

          
            <div className="Main">
              
              {photo ? <img src={photo} alt=""></img> :<div> <img
